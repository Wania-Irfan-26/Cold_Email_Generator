...
"""
user_company = input("Emter Company Name:")
user_name = input("Enter your name: ")
user_url = input("Enter Company's url: ")
...
task_analyze = Task(
    description=f"Scrape the website {user_company}from given url {user_url}. Summarize what the company does and identify 1 key area where they could improve (e.g., design, traffic, automation).",
...
task_write = Task(
    ...
    expected_output=f"A professional cold email ready to send with user's name in regards portion from {user_name}.",
    agent=writer
)
...
sales_crew = Crew(
    ...
    final_cold_email = "Final Email.txt",
    verbose=True
)
